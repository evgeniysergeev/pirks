...
TEST_F(MemoryUtilsTest, DumpMemoryToString_Basic)
{
    ...
    std::string result = dumpMemoryToString(std::span { data });
...
TEST_F(MemoryUtilsTest, DumpMemoryToString_WithPrefix)
{
    ...
    std::string          result = dumpMemoryToString(std::span { data }, "TEST: ");
...
TEST_F(MemoryUtilsTest, LogMemoryDump_Levels)
{
    ...
    logMemoryDump(std::span { data }, "", spdlog::level::debug);
...
TEST_F(MemoryUtilsTest, DumpMemoryToString_LargeOffset)
{
    ...
    std::string result = dumpMemoryToString(span);
...
TEST_F(MemoryUtilsTest, DumpMemoryToString_LongPrefix)
{
    ...
    std::string          result = dumpMemoryToString(std::span { data }, prefix);
